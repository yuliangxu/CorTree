...
```{r sim-mean-profiles, fig.cap="Average simulated count profile by true group."}
...
```{r sim-heatmap, fig.cap="Heatmap of log1p counts sorted by true group."}
ord <- order(Z_true)
...
```{r sim-cortree-cluster-means, fig.cap="Average count profiles by fitted CorTree cluster."}
...
```{r sim-sigma, fig.cap="Fitted CorTree Sigma matrices for the two clusters.", fig.width=9, fig.height=4}
...
```{r sim-cluster-compare, fig.cap="True groups versus CorTree hard cluster assignments."}
